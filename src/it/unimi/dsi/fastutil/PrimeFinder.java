 ...
 * keep capacities prime.  This class provides efficient means to choose prime capacities.
 *
...
public final class PrimeFinder {
  /**
   * The prime number list. Primes are chosen such that for any desired capacity >= 1000 the list includes a prime number <= desired capacity * 1.11.
   * <p>
   ...
   * <p>
   * Primes are chosen such that they are optimized for a hashtable growthfactor of 2.0;
   * <p>
   * If your hashtable has such a growthfactor then, after initially "rounding to a prime" upon hashtable construction, it will later expand to prime capacities such that there
   * exist no better primes.
   * <p>
